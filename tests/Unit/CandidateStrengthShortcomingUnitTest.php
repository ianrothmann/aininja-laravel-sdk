...
it('can generate an candidate strength shortcoming', function () {
  ...
  ### 0 - No Competence / Off-topic")
        ->whereRatingTable("| Question asked | Score | Reason |
  |---|---|---|
  | Send us a video where you introduce yourself. Keep the video less than 30 seconds | 5.00 | The candidate's response is exemplary. It directly addresses all aspects of the ideal answer, introducing the candidate's name, current role, and experience, and provides a brief example of how they applied their skills to solve a business problem. The response is clear, concise, and well-articulated, demonstrating a strong understanding of the context. The originality is seen in the unique business problem they solved—evaluating customer support calls in real-time. Therefore, it fully encompasses all the desired points and merits a top score. |
  | Do you have experience in using machine learning and AI to drive business results? Please provide examples. | 1.00 | The candidate confirmed having experience using machine learning and AI to drive business results, addressing the main point of the question. However, the response lacks depth and detail as no specific examples were provided, which was a key aspect of the ideal answer. The response, therefore, demonstrates limited competency. There's no clarity or originality, and the context isn't well demonstrated due to the lack of specific examples. Overall, the candidate's response falls short of the expectations set by the ideal answer. |
  | How would you handle a situation where your predictive model is not delivering the desired outcomes? | 3.00 | The candidate's answer is satisfactory. He addresses some aspects of the ideal answer, specifically in terms of gathering more data and trying different models when the current one is not delivering desired outcomes. He also highlights the importance of communication, but does not elaborate on how he would communicate these issues to stakeholders. The response lacks depth in terms of the specific steps to diagnose the model's issues, which is a significant part of the ideal answer. |")
        ->get();
