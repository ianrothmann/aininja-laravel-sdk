...
it('can generate criteria for an item in a scoring guide', function () {
    ...
    $result = $handler->scoringGuideGenerateCriteria()
        ...
        ->addExampleOfGoodResponse("Proposes using a CRM system to automate customer interactions, offering personalized recommendations and improving engagement.")
        ->addExampleOfGoodResponse("Mentions using cloud-based accounting software to improve financial management and AI-based tools to automate home measurement tasks.")
        ->get();
